    ...
    public function renderLayout(MvcEvent $e)
    {
        ...
        if(0) {
	        ...
	        if (($this->layout !== $this->view->layout ()->getLayout ()) && (strstr ( $this->view->layout ()->getLayout (), '.phtml' ))) {
	        	// If the getLayout is different from default layout and contains
	        	// .phtml
	        	...
	        	// If default layout filename (without phtml) does not equal
	        	// getLayout then select differnet view file within the same
	        	// directory as the default layout
