 ...
 */
class AuditAttributes extends Entity implements Audit
{
    public function getGetterSetterMap() {
        return array (
            ...
            'getOriginalAttributeSet' => 'setOriginalAttributeSet',
            'getCode'       => 'setCode',
            'getLabel'      => 'setLabel',
            ...
            'getSort'       => 'setSort',
            'getTab'        => 'setTab',
            'getIsRequired' => 'setIsRequired',
            'getIsUnique'   => 'setIsUnique',
            'getIsIncludedInSummary' => 'setIsIncludedInSummary'
        );
    }
     ...
     *
     * @ORM\ManyToOne(targetEntity="AuditRenderers", inversedBy="attributes")
     ...
     *
     * @ORM\ManyToOne(targetEntity="AuditAttributeSets", inversedBy="originalAttributes")
