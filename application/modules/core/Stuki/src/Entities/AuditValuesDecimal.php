...
/**
 * @ORM\Entity
 * @ORM\Table(name="audit_values_decimal", indexes={@ORM\index(name="value_key_idx", columns={"value_key"})})
 */
class AuditValuesDecimal extends Entity implements Value, Audit
{
